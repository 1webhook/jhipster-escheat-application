...
@RestController
@RequestMapping("/api/hhipsterescheatclaim-kafka")
public class HhipsterescheatclaimKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HhipsterescheatclaimKafkaResource.class);
    ...
    public HhipsterescheatclaimKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
